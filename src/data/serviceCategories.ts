...
export const topLevelCategories: TopLevelCategory[] = [
  {
    ...
    subcategories: [
      ...
      { id: 'foundation-repair', name: 'Foundation Repair', slug: 'foundation-repair', description: 'Foundation inspection and repair', icon: '🏗️', keywords: ['foundation', 'leveling', 'pier', 'crack', 'settling'] },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { id: 'windshield-glass', name: 'Windshield/Glass', slug: 'windshield-glass', description: 'Auto glass repair and replacement', icon: '🪟', keywords: ['windshield', 'auto glass', 'chip', 'crack', 'window'] },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { id: 'wildlife-management', name: 'Wildlife Management', slug: 'wildlife-management', description: 'Wildlife management and trapping', icon: '🦌', keywords: ['wildlife', 'trapping', 'deer', 'hog', 'varmint'] },
      { id: 'barn-shop', name: 'Barn/Shop Build', slug: 'barn-shop', description: 'Barn and shop construction', icon: '🏚️', keywords: ['barn', 'shop', 'metal building', 'pole barn', 'outbuilding'] },
    ],
  },
  {
    id: 'commercial',
