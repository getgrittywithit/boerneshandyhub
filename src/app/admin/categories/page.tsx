...
import { serviceBuckets, serviceCategories, ServiceBucket, ServiceCategory } from '@/data/serviceCategories';
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center max-w-md">
          ...
          <p className="text-gray-600 mb-6">Please sign in to access category management.</p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              ...
              <p className="mt-1 text-boerne-gold text-sm">Manage service buckets and categories</p>
            </div>
          </div>
        </div>
      </header>
