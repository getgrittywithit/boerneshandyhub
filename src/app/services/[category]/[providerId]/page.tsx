...
export default function ProviderDetailPage() {
  ...
  const categoryData = getServiceCategory(category as string);

  useEffect(() => {
    // Find the provider
    const foundProvider = serviceProvidersData.providers.find(
    ...
    return (
      <div className="bg-boerne-light-gray min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-boerne-dark-gray">Loading provider details...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="bg-boerne-light-gray min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold text-boerne-navy mb-4">Provider Not Found</h1>
          <p className="text-boerne-dark-gray mb-6">We couldn't find the service provider you're looking for.</p>
          <Link
            href="/services"
